...
<link href="css/useroperate/zhuce.css" rel="stylesheet" type="text/css"/>
</head>
...
<body>
	<div class="login_logo" style="height: 80px;margin-left: 80px;" >
		...
		<div style="font-size: 15px;margin-left: 950px;margin-bottom: 100px;"><a href="index.jsp">立即登录</a>||<a href="forgetmm.jsp">找回密码</a></div>
		</div>
	</div>
	<hr />
	<div class="form-bak" style="margin-top: 100px;background-image:images/login_bgx.gif;height: 500px;" >
		<form method="post" action="user/reg.do" onsubmit="adaptValue();">
			<div class="left">
